...
def main(**args):
    ...
    rec_metric(args, res_list,label_list, logger)
...
if  __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Quadra AI Python Inference API for PaddleOCR evaluation')
    # Load file
    ...
    parser.add_argument("--test_text", type=str, default="./test.txt", \
                        help='path to text file with test image path and label')
    parser.add_argument("--prefix", type=str, default="./", \
                        help='prefix add to test text')
    parser.add_argument('--input_npy_save', dest='input_npy_save', action='store_true',
                        help='Save pre-processed input(float32) as npy')
    ...
    parser.add_argument('--save_as_RGB', dest='save_as_RGB', action='store_true',
                        help='ave preprocessed image as RGB (default is False)')    # Dirs
    ...
    parser.add_argument('--ignore_space',  action='store_true', default=False,\
                        help='ignore the space')

    parser.add_argument('--is_filter',  action='store_true', default=False,\
                        help='normalize_text')

    parser.add_argument("--opts_dir", type=str, default="./icdar_eval", \
                        help='path of outputs files ')
    argspar = parser.parse_args()    

    print("\n### Evaluate PaddleOCR onnx model ###")
    print("> Parameters:")
